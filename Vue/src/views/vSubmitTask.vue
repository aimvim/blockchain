    ...
    <div class="common-layout">
      ...
      <div class="content">
        ...
        <div contentbody>
          ...
          <span class="taskKey" style="vertical-align:140%;">活动内容</span> <div class="taskValue" id="taskContent" >{{ taskContent }}</div><br>
          <span style="text-align: center;margin-left: 30vw;">************龙哥插个上传图片的组件呗我的不全**************</span><br>
        
          <span ><button class="accept">提交任务</button><button class="cancel" @click="goback()">取消</button>
        </span>
        </div>
      </div>
    </div>
